...
declare module '@pezkuwi/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    crowdloan: {
       ...
       **/
      HandleBidResult: AugmentedEvent<ApiType, [paraId: u32, result: Result<Null, PezspRuntimeDispatchError>], { paraId: u32, result: Result<Null, PezspRuntimeDispatchError> }>;
      /**
    ...
    hrmp: {
       ...
       * HRMP channel closed.
       **/
      ChannelClosed: AugmentedEvent<ApiType, [byParachain: u32, channelId: PezkuwiTeyrchainPrimitivesPrimitivesHrmpChannelId], { byParachain: u32, channelId: PezkuwiTeyrchainPrimitivesPrimitivesHrmpChannelId }>;
      /**
       ...
       **/
      OpenChannelCanceled: AugmentedEvent<ApiType, [byParachain: u32, channelId: PezkuwiTeyrchainPrimitivesPrimitivesHrmpChannelId], { byParachain: u32, channelId: PezkuwiTeyrchainPrimitivesPrimitivesHrmpChannelId }>;
      /**
    ...
    messageQueue: {
       ...
       **/
      OverweightEnqueued: AugmentedEvent<ApiType, [id: U8aFixed, origin: PezkuwiRuntimeTeyrchainsInclusionAggregateMessageOrigin, pageIndex: u32, messageIndex: u32], { id: U8aFixed, origin: PezkuwiRuntimeTeyrchainsInclusionAggregateMessageOrigin, pageIndex: u32, messageIndex: u32 }>;
      /**
       * This page was reaped.
       **/
      PageReaped: AugmentedEvent<ApiType, [origin: PezkuwiRuntimeTeyrchainsInclusionAggregateMessageOrigin, index: u32], { origin: PezkuwiRuntimeTeyrchainsInclusionAggregateMessageOrigin, index: u32 }>;
      /**
       * Message is processed.
       **/
      Processed: AugmentedEvent<ApiType, [id: H256, origin: PezkuwiRuntimeTeyrchainsInclusionAggregateMessageOrigin, weightUsed: PezspWeightsWeightV2Weight, success: bool], { id: H256, origin: PezkuwiRuntimeTeyrchainsInclusionAggregateMessageOrigin, weightUsed: PezspWeightsWeightV2Weight, success: bool }>;
      /**
       * Message discarded due to an error in the `MessageProcessor` (usually a format error).
       **/
      ProcessingFailed: AugmentedEvent<ApiType, [id: H256, origin: PezkuwiRuntimeTeyrchainsInclusionAggregateMessageOrigin, error: PezframeSupportMessagesProcessMessageError], { id: H256, origin: PezkuwiRuntimeTeyrchainsInclusionAggregateMessageOrigin, error: PezframeSupportMessagesProcessMessageError }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    parameters: {
       ...
       **/
      Updated: AugmentedEvent<ApiType, [key: StagingDicleRuntimeRuntimeParametersKey, oldValue: Option<StagingDicleRuntimeRuntimeParametersValue>, newValue: Option<StagingDicleRuntimeRuntimeParametersValue>], { key: StagingDicleRuntimeRuntimeParametersKey, oldValue: Option<StagingDicleRuntimeRuntimeParametersValue>, newValue: Option<StagingDicleRuntimeRuntimeParametersValue> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    rcMigrator: {
       ...
       **/
      AhUmpQueuePriorityConfigSet: AugmentedEvent<ApiType, [old: PezpalletRcMigratorQueuePriority, new_: PezpalletRcMigratorQueuePriority], { old: PezpalletRcMigratorQueuePriority, new_: PezpalletRcMigratorQueuePriority }>;
      /**
       ...
       **/
      ManagerMultisigDispatched: AugmentedEvent<ApiType, [res: Result<Null, PezspRuntimeDispatchError>], { res: Result<Null, PezspRuntimeDispatchError> }>;
      /**
       ...
       **/
      MigrationPaused: AugmentedEvent<ApiType, [pauseStage: PezpalletRcMigratorMigrationStage], { pauseStage: PezpalletRcMigratorMigrationStage }>;
      /**
       ...
       **/
      StageTransition: AugmentedEvent<ApiType, [old: PezpalletRcMigratorMigrationStage, new_: PezpalletRcMigratorMigrationStage], { old: PezpalletRcMigratorMigrationStage, new_: PezpalletRcMigratorMigrationStage }>;
      /**
