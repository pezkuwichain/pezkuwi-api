...
declare module '@pezkuwi/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    alliance: {
       ...
       **/
      Announced: AugmentedEvent<ApiType, [announcement: PezpalletAllianceCid], { announcement: PezpalletAllianceCid }>;
      /**
       * An on-chain announcement has been removed.
       **/
      AnnouncementRemoved: AugmentedEvent<ApiType, [announcement: PezpalletAllianceCid], { announcement: PezpalletAllianceCid }>;
      /**
       ...
       **/
      NewRuleSet: AugmentedEvent<ApiType, [rule: PezpalletAllianceCid], { rule: PezpalletAllianceCid }>;
      /**
       * Accounts or websites have been added into the list of unscrupulous items.
       **/
      UnscrupulousItemAdded: AugmentedEvent<ApiType, [items: Vec<PezpalletAllianceUnscrupulousItem>], { items: Vec<PezpalletAllianceUnscrupulousItem> }>;
      /**
       * Accounts or websites have been removed from the list of unscrupulous items.
       **/
      UnscrupulousItemRemoved: AugmentedEvent<ApiType, [items: Vec<PezpalletAllianceUnscrupulousItem>], { items: Vec<PezpalletAllianceUnscrupulousItem> }>;
      /**
       * Generic event
       **/
    ...
    allianceMotion: {
       ...
       **/
      Executed: AugmentedEvent<ApiType, [proposalHash: H256, result: Result<Null, PezspRuntimeDispatchError>], { proposalHash: H256, result: Result<Null, PezspRuntimeDispatchError> }>;
      /**
       ...
       **/
      MemberExecuted: AugmentedEvent<ApiType, [proposalHash: H256, result: Result<Null, PezspRuntimeDispatchError>], { proposalHash: H256, result: Result<Null, PezspRuntimeDispatchError> }>;
      /**
    ...
    assetConversion: {
       ...
       **/
      SwapCreditExecuted: AugmentedEvent<ApiType, [amountIn: u128, amountOut: u128, path: Vec<ITuple<[PezframeSupportTokensFungibleUnionOfNativeOrWithId, u128]>>], { amountIn: u128, amountOut: u128, path: Vec<ITuple<[PezframeSupportTokensFungibleUnionOfNativeOrWithId, u128]>> }>;
      /**
    ...
    assetRate: {
      AssetRateCreated: AugmentedEvent<ApiType, [assetKind: PezframeSupportTokensFungibleUnionOfNativeOrWithId, rate: u128], { assetKind: PezframeSupportTokensFungibleUnionOfNativeOrWithId, rate: u128 }>;
      AssetRateRemoved: AugmentedEvent<ApiType, [assetKind: PezframeSupportTokensFungibleUnionOfNativeOrWithId], { assetKind: PezframeSupportTokensFungibleUnionOfNativeOrWithId }>;
      AssetRateUpdated: AugmentedEvent<ApiType, [assetKind: PezframeSupportTokensFungibleUnionOfNativeOrWithId, old: u128, new_: u128], { assetKind: PezframeSupportTokensFungibleUnionOfNativeOrWithId, old: u128, new_: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    broker: {
       ...
       **/
      Assigned: AugmentedEvent<ApiType, [regionId: PezpalletBrokerRegionId, duration: u32, task: u32], { regionId: PezpalletBrokerRegionId, duration: u32, task: u32 }>;
      /**
       * An assignment has been removed from the workplan.
       **/
      AssignmentRemoved: AugmentedEvent<ApiType, [regionId: PezpalletBrokerRegionId], { regionId: PezpalletBrokerRegionId }>;
       ...
       **/
      ContributionDropped: AugmentedEvent<ApiType, [regionId: PezpalletBrokerRegionId], { regionId: PezpalletBrokerRegionId }>;
      /**
       * A Core has been assigned to one or more tasks and/or the Pool on the Relay-chain.
       **/
      CoreAssigned: AugmentedEvent<ApiType, [core: u16, when: u32, assignment: Vec<ITuple<[PezpalletBrokerCoretimeInterfaceCoreAssignment, u16]>>], { core: u16, when: u32, assignment: Vec<ITuple<[PezpalletBrokerCoretimeInterfaceCoreAssignment, u16]>> }>;
      /**
       ...
       **/
      Interlaced: AugmentedEvent<ApiType, [oldRegionId: PezpalletBrokerRegionId, newRegionIds: ITuple<[PezpalletBrokerRegionId, PezpalletBrokerRegionId]>], { oldRegionId: PezpalletBrokerRegionId, newRegionIds: ITuple<[PezpalletBrokerRegionId, PezpalletBrokerRegionId]> }>;
      /**
       ...
       **/
      Partitioned: AugmentedEvent<ApiType, [oldRegionId: PezpalletBrokerRegionId, newRegionIds: ITuple<[PezpalletBrokerRegionId, PezpalletBrokerRegionId]>], { oldRegionId: PezpalletBrokerRegionId, newRegionIds: ITuple<[PezpalletBrokerRegionId, PezpalletBrokerRegionId]> }>;
      /**
       * A Region has been added to the Instantaneous Coretime Pool.
       **/
      Pooled: AugmentedEvent<ApiType, [regionId: PezpalletBrokerRegionId, duration: u32], { regionId: PezpalletBrokerRegionId, duration: u32 }>;
      /**
       * Some historical Instantaneous Core Pool payment record has been dropped.
       **/
       ...
       **/
      RegionDropped: AugmentedEvent<ApiType, [regionId: PezpalletBrokerRegionId, duration: u32], { regionId: PezpalletBrokerRegionId, duration: u32 }>;
      /**
       * The workload of a core has become renewable.
       **/
      Renewable: AugmentedEvent<ApiType, [core: u16, price: u128, begin: u32, workload: Vec<PezpalletBrokerScheduleItem>], { core: u16, price: u128, begin: u32, workload: Vec<PezpalletBrokerScheduleItem> }>;
      /**
       ...
       **/
      ReservationCancelled: AugmentedEvent<ApiType, [index: u32, workload: Vec<PezpalletBrokerScheduleItem>], { index: u32, workload: Vec<PezpalletBrokerScheduleItem> }>;
      /**
       * There is a new reservation for a workload.
       **/
      ReservationMade: AugmentedEvent<ApiType, [index: u32, workload: Vec<PezpalletBrokerScheduleItem>], { index: u32, workload: Vec<PezpalletBrokerScheduleItem> }>;
      /**
       * The act of claiming revenue has begun.
       **/
      RevenueClaimBegun: AugmentedEvent<ApiType, [region: PezpalletBrokerRegionId, maxTimeslices: u32], { region: PezpalletBrokerRegionId, maxTimeslices: u32 }>;
      /**
    ...
    coreFellowship: {
       ...
       **/
      ParamsChanged: AugmentedEvent<ApiType, [params: PezpalletCoreFellowshipParamsTypeU128], { params: PezpalletCoreFellowshipParamsTypeU128 }>;
      /**
    ...
    democracy: {
       ...
       **/
      MetadataCleared: AugmentedEvent<ApiType, [owner: PezpalletDemocracyMetadataOwner, hash_: H256], { owner: PezpalletDemocracyMetadataOwner, hash_: H256 }>;
      /**
       * Metadata for a proposal or a referendum has been set.
       **/
      MetadataSet: AugmentedEvent<ApiType, [owner: PezpalletDemocracyMetadataOwner, hash_: H256], { owner: PezpalletDemocracyMetadataOwner, hash_: H256 }>;
      /**
       * Metadata has been transferred to new owner.
       **/
      MetadataTransferred: AugmentedEvent<ApiType, [prevOwner: PezpalletDemocracyMetadataOwner, owner: PezpalletDemocracyMetadataOwner, hash_: H256], { prevOwner: PezpalletDemocracyMetadataOwner, owner: PezpalletDemocracyMetadataOwner, hash_: H256 }>;
      /**
       ...
       **/
      Started: AugmentedEvent<ApiType, [refIndex: u32, threshold: PezpalletDemocracyVoteThreshold], { refIndex: u32, threshold: PezpalletDemocracyVoteThreshold }>;
      /**
    ...
    electionProviderMultiPhase: {
       ...
       **/
      ElectionFinalized: AugmentedEvent<ApiType, [compute: PezpalletElectionProviderMultiPhaseElectionCompute, score: PezspNposElectionsElectionScore], { compute: PezpalletElectionProviderMultiPhaseElectionCompute, score: PezspNposElectionsElectionScore }>;
      /**
       * There was a phase transition in a given round.
       **/
      PhaseTransitioned: AugmentedEvent<ApiType, [from: PezpalletElectionProviderMultiPhasePhase, to: PezpalletElectionProviderMultiPhasePhase, round: u32], { from: PezpalletElectionProviderMultiPhasePhase, to: PezpalletElectionProviderMultiPhasePhase, round: u32 }>;
      /**
    ...
    grandpa: {
       ...
       **/
      NewAuthorities: AugmentedEvent<ApiType, [authoritySet: Vec<ITuple<[PezspConsensusGrandpaAppPublic, u64]>>], { authoritySet: Vec<ITuple<[PezspConsensusGrandpaAppPublic, u64]>> }>;
      /**
    ...
    imOnline: {
       ...
       **/
      HeartbeatReceived: AugmentedEvent<ApiType, [authorityId: PezpalletImOnlineSr25519AppSr25519Public], { authorityId: PezpalletImOnlineSr25519AppSr25519Public }>;
      /**
    ...
    messageQueue: {
       ...
       **/
      Processed: AugmentedEvent<ApiType, [id: H256, origin: u32, weightUsed: PezspWeightsWeightV2Weight, success: bool], { id: H256, origin: u32, weightUsed: PezspWeightsWeightV2Weight, success: bool }>;
      /**
       * Message discarded due to an error in the `MessageProcessor` (usually a format error).
       **/
      ProcessingFailed: AugmentedEvent<ApiType, [id: H256, origin: u32, error: PezframeSupportMessagesProcessMessageError], { id: H256, origin: u32, error: PezframeSupportMessagesProcessMessageError }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    metaTx: {
       ...
       * information.
       **/
      Dispatched: AugmentedEvent<ApiType, [result: Result<PezframeSupportDispatchPostDispatchInfo, PezspRuntimeDispatchErrorWithPostInfo>], { result: Result<PezframeSupportDispatchPostDispatchInfo, PezspRuntimeDispatchErrorWithPostInfo> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    rankedPolls: {
       ...
       * A referendum has been cancelled.
       **/
      Cancelled: AugmentedEvent<ApiType, [index: u32, tally: PezpalletRankedCollectiveTally], { index: u32, tally: PezpalletRankedCollectiveTally }>;
      ConfirmAborted: AugmentedEvent<ApiType, [index: u32], { index: u32 }>;
      /**
       * A referendum has ended its confirmation phase and is ready for approval.
       **/
      Confirmed: AugmentedEvent<ApiType, [index: u32, tally: PezpalletRankedCollectiveTally], { index: u32, tally: PezpalletRankedCollectiveTally }>;
       ...
       **/
      DecisionStarted: AugmentedEvent<ApiType, [index: u32, track: u16, proposal: PezframeSupportPreimagesBounded, tally: PezpalletRankedCollectiveTally], { index: u32, track: u16, proposal: PezframeSupportPreimagesBounded, tally: PezpalletRankedCollectiveTally }>;
      /**
       ...
       **/
      Killed: AugmentedEvent<ApiType, [index: u32, tally: PezpalletRankedCollectiveTally], { index: u32, tally: PezpalletRankedCollectiveTally }>;
      /**
       ...
       * A proposal has been rejected by referendum.
       **/
      Rejected: AugmentedEvent<ApiType, [index: u32, tally: PezpalletRankedCollectiveTally], { index: u32, tally: PezpalletRankedCollectiveTally }>;
      /**
       ...
       **/
      TimedOut: AugmentedEvent<ApiType, [index: u32, tally: PezpalletRankedCollectiveTally], { index: u32, tally: PezpalletRankedCollectiveTally }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    safeMode: {
       ...
       **/
      Exited: AugmentedEvent<ApiType, [reason: PezpalletSafeModeExitReason], { reason: PezpalletSafeModeExitReason }>;
      /**
    ...
    staking: {
       ...
       **/
      ForceEra: AugmentedEvent<ApiType, [mode: PezpalletStakingForcing], { mode: PezpalletStakingForcing }>;
      /**
    ...
    sudo: {
       ...
       **/
      Sudid: AugmentedEvent<ApiType, [sudoResult: Result<Null, PezspRuntimeDispatchError>], { sudoResult: Result<Null, PezspRuntimeDispatchError> }>;
      /**
       * A [sudo_as](Pallet::sudo_as) call just took place.
       **/
      SudoAsDone: AugmentedEvent<ApiType, [sudoResult: Result<Null, PezspRuntimeDispatchError>], { sudoResult: Result<Null, PezspRuntimeDispatchError> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
