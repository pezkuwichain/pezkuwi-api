...
declare module '@pezkuwi/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    aura: {
       ...
       **/
      authorities: AugmentedQuery<ApiType, () => Observable<Vec<PezspConsensusAuraEd25519AppEd25519Public>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    parameters: {
       ...
       * Stored parameters.
       **/
      parameters: AugmentedQuery<ApiType, (arg: AssetHubPezkuwiRuntimeRuntimeParametersKey | { StakingElection: any } | { Scheduler: any } | { MessageQueue: any } | string | Uint8Array) => Observable<Option<AssetHubPezkuwiRuntimeRuntimeParametersValue>>, [AssetHubPezkuwiRuntimeRuntimeParametersKey]> & QueryableStorageEntry<ApiType, [AssetHubPezkuwiRuntimeRuntimeParametersKey]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
