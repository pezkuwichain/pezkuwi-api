...
import type { AccountId32, H160, H256, Perbill, Permill } from '@pezkuwi/types/interfaces/runtime';
...
declare module '@pezkuwi/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    multiBlockElectionSigned: {
       ...
       **/
      Registered: AugmentedEvent<ApiType, [u32, AccountId32, PezspNposElectionsElectionScore]>;
      /**
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: AssetHubDicleRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: AssetHubDicleRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: AssetHubDicleRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: AssetHubDicleRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: AssetHubDicleRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: AssetHubDicleRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * A pure proxy was killed by its spawner.
       **/
      PureKilled: AugmentedEvent<ApiType, [pure: AccountId32, spawner: AccountId32, proxyType: AssetHubDicleRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, spawner: AccountId32, proxyType: AssetHubDicleRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    staking: {
       ...
       **/
      Rewarded: AugmentedEvent<ApiType, [stash: AccountId32, dest: PezpalletStakingAsyncRewardDestination, amount: u128], { stash: AccountId32, dest: PezpalletStakingAsyncRewardDestination, amount: u128 }>;
      /**
       ...
       **/
      ValidatorPrefsSet: AugmentedEvent<ApiType, [stash: AccountId32, prefs: PezpalletStakingAsyncValidatorPrefs], { stash: AccountId32, prefs: PezpalletStakingAsyncValidatorPrefs }>;
      /**
