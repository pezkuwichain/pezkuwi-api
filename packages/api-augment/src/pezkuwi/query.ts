...
declare module '@pezkuwi/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    rcMigrator: {
       ...
       **/
      settings: AugmentedQuery<ApiType, () => Observable<Option<PezpalletRcMigratorMigrationSettings>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    referenda: {
       ...
       **/
      referendumInfoFor: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PezpalletReferendaReferendumInfo>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
