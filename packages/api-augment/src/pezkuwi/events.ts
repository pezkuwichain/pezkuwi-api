...
declare module '@pezkuwi/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    rcMigrator: {
       ...
       **/
      MigrationSettingsSet: AugmentedEvent<ApiType, [old: Option<PezpalletRcMigratorMigrationSettings>, new_: Option<PezpalletRcMigratorMigrationSettings>], { old: Option<PezpalletRcMigratorMigrationSettings>, new_: Option<PezpalletRcMigratorMigrationSettings> }>;
      /**
