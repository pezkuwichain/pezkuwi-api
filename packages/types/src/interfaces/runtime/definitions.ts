...
// in a pure Bizinikiwi/Pezkuwi implementation, any other custom origins won't be handled at all
export const knownOrigins: Record<string, string> = {
  //
  // (1) Defaults from Bizinikiwi
  //
  Council: 'CollectiveOrigin',
  System: 'SystemOrigin',
  TechnicalCommittee: 'CollectiveOrigin',
  //
  // (2) Defaults from Pezkuwi
  //
  Xcm: 'XcmOrigin',
  XcmPezpallet: 'XcmOrigin',
  //
