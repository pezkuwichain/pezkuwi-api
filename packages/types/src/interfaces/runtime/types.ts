...
import type { GenericAccountId32, GenericAccountId33, GenericAccountIndex, GenericBlock, GenericCall, GenericConsensusEngineId, GenericEthereumAccountId, GenericLookupSource, GenericMultiAddress, StorageKey } from '@pezkuwi/types';
import type { Bytes, Compact, DoNotConstruct, Enum, Int, Null, Option, Struct, U8aFixed, UInt, Vec, u16, u32, u64, u8 } from '@pezkuwi/types-codec';
...
/** @name PezpalletId */
export interface PezpalletId extends LockIdentifier {}

/** @name PezpalletsOrigin */
export interface PezpalletsOrigin extends OriginCaller {}

/** @name PezpalletVersion */
export interface PezpalletVersion extends Struct {
  readonly major: u16;
  readonly minor: u8;
  readonly patch: u8;
}
