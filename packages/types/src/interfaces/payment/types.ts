...
import type { Option, Struct } from '@pezkuwi/types-codec';
import type { Balance, Weight, WeightV1, WeightV2 } from '@pezkuwi/types/interfaces/runtime';
import type { DispatchClass } from '@pezkuwi/types/interfaces/system';
